...
/**
 * {@link EmptyMasterPasswordListener} implements the action that should be done when the user clicks on the empty
 * master password label.
 * 
 * @author Stefan Franke
 * @date 07.02.2008
 * @version ($Id: EmptyMasterPasswordListener.java 6 2008-04-05 11:21:53Z frankesn $)
 */
public class EmptyMasterPasswordListener implements MouseListener {
	...
	/**
	 * Creates a new {@link EmptyMasterPasswordListener}.
	 * 
	 * @param checkbox 
	 */
	public EmptyMasterPasswordListener(JCheckBox checkbox) {
